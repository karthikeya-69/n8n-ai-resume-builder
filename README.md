...
1️⃣ User submits resume details

2️⃣ n8n webhook receives data

3️⃣ Gemini AI generates ATS-friendly resume

4️⃣ PDF is automatically created

5️⃣ Resume is delivered via email
